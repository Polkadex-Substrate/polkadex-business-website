...
const ESLanguage = {
  ...
  announcement: {
    title: 'Polkadex Contract',
    ctaButton: 'Ver en Etherscan',
  },
  hero: {
    title: 'El trading comercial para Web3 y DeFi',
    description:
      'Polkadex es una exchange de criptomonedas basado en el libro de pedidos p2p totalmente descentralizado para el ecosistema DeFi construido en Substrate',
    ctaButton: 'Explorar Testnet',
    chainsTitle: 'Cadenas Soportadas',
  },
  orderbook: {
    tag: 'Products',
    title: 'Polkadex',
